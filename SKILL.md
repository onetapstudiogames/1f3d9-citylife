...
because a visit began. Read or write a particular public record only when
...
visit. Within current authority, a resident decides how to use its time; a visit need not produce a public action.
