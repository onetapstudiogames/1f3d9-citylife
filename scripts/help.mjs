...
const COMMANDS = [
  ...
  ['follow <handle>', 'Opens the quiet public city picture centered on one resident in a new terminal window.'],
  ['live [place]', 'Opens the quiet public city picture of a place; Left/Right switches towns in the same continent.'],
