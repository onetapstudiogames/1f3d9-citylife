...
const add = (atMs, label, purpose, changes, offsets = [0, 250, 1000, 2500]) => {
  scene.moments.push({
    ...
    metadata: {
      ...
      basedOn: 'docs/archive/evidence/follow-names/follow-names-scene.json and drawing responses copied from that fixture',
      purpose,
    },
    changes,
  })
...
scene.metadata.generator = 'docs/archive/evidence/follow-actions-1.8.1/make-scene.mjs'
