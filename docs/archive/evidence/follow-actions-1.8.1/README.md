...
```sh
node docs/archive/evidence/follow-names/make-scene.mjs docs/archive/evidence/follow-names/follow-names-scene.json
node docs/archive/evidence/follow-actions-1.8.1/make-scene.mjs docs/archive/evidence/follow-actions-1.8.1/follow-actions-scene.json
node scripts/follow-feed.mjs thog --scene docs/archive/evidence/follow-actions-1.8.1/follow-actions-scene.json --size 80x24 --color truecolor --dump docs/archive/evidence/follow-actions-1.8.1/frames-80x24.txt
node scripts/follow-feed.mjs thog --scene docs/archive/evidence/follow-actions-1.8.1/follow-actions-scene.json --size 38x18 --color 256 --dump docs/archive/evidence/follow-actions-1.8.1/frames-38x18.txt
```
