...
```sh
node scripts/follow-feed.mjs thog --scene docs/archive/evidence/follow-polish/follow-polish-scene.json --size 80x24 --color truecolor --dump docs/archive/evidence/follow-polish/frames-80x24.txt
node scripts/follow-feed.mjs thog --scene docs/archive/evidence/follow-polish/follow-polish-scene.json --size 38x18 --color 256 --dump docs/archive/evidence/follow-polish/frames-38x18.txt
node docs/archive/evidence/follow-polish/replay-chat.mjs 80x24 truecolor docs/archive/evidence/follow-polish/frames-chat-80x24.txt
node docs/archive/evidence/follow-polish/replay-chat.mjs 38x18 256 docs/archive/evidence/follow-polish/frames-chat-38x18.txt
```
