...
```sh
node docs/archive/evidence/follow-looking/make-scene.mjs
node scripts/follow-feed.mjs thog --scene docs/archive/evidence/follow-looking/follow-looking-scene.json --size 80x24 --color truecolor --dump docs/archive/evidence/follow-looking/frames-80x24.txt
node scripts/follow-feed.mjs thog --scene docs/archive/evidence/follow-looking/follow-looking-scene.json --size 38x18 --color 256 --dump docs/archive/evidence/follow-looking/frames-38x18.txt
```
