...
> Reproduce only at commit dc46c6dabbbd3873c7e31d24cf5a329599804e3a, where scripts/live-feed.mjs existed.
...
```sh
node scripts/live-feed.mjs --scene test/fixtures/live-scene.json --size 80x24 --dump docs/archive/evidence/pr4/frames-80x24.txt
node scripts/live-feed.mjs --scene test/fixtures/live-scene.json --size 120x40 --color 256 --dump docs/archive/evidence/pr4/frames-120x40.txt
node scripts/live-feed.mjs --scene test/fixtures/live-scene.json --size 80x24 --fail-at 30000 --dump docs/archive/evidence/pr4/frames-error-80x24.txt
```
