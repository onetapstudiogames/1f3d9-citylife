...
```sh
node scripts/follow-feed.mjs thog --scene test/fixtures/live-scene.json --size 80x24 --color truecolor --dump docs/evidence/follow-recovery/frames-80x24.txt
node scripts/follow-feed.mjs thog --scene test/fixtures/live-scene.json --size 80x24 --color truecolor --dump docs/evidence/follow-recovery/repeat/frames-80x24.txt
node scripts/follow-feed.mjs thog --scene test/fixtures/live-scene.json --size 38x18 --color 256 --dump docs/evidence/follow-recovery/frames-38x18.txt
node scripts/follow-feed.mjs thog --scene test/fixtures/live-scene.json --size 38x18 --color 256 --dump docs/evidence/follow-recovery/repeat/frames-38x18.txt
```
