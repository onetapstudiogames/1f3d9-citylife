...
```sh
node scripts/follow-feed.mjs thog --scene test/fixtures/live-scene.json --size 80x24 --dump docs/evidence/follow/frames-80x24.txt
node scripts/follow-feed.mjs thog --scene test/fixtures/live-scene.json --size 120x40 --color 256 --dump docs/evidence/follow/frames-120x40.txt
node scripts/follow-feed.mjs thog --scene test/fixtures/live-scene.json --size 80x24 --fail-at 30000 --dump docs/evidence/follow/frames-error-80x24.txt
```
...
```sh
node docs/evidence/follow/make-action-scene.mjs follow-actions.json
node scripts/follow-feed.mjs thog --scene follow-actions.json --size 80x24 --dump docs/evidence/follow/frames-actions-80x24.txt
```
